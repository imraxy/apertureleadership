...
@section('content')
	...
	<div class="m-portlet">
		...
		<!--begin::Form-->
		<form method="post" class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.edit_testimonial', $testimonial->id)}}" enctype="multipart/form-data">
			@method('PUT')
				...
				<div class="m-form__section m-form__section--first">
					<div class="form-group m-form__group row @error('name') has-danger @enderror">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<input type="text" class="form-control m-input" name="name" id="name" value="{{old('name', $testimonial->name ?? '')}}" placeholder="Name" autocomplete="name" autofocus>
							@error('name')
					...
					<div class="form-group m-form__group row @error('message') has-danger @enderror">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<textarea class="form-control" name="message" placeholder="Message" rows="5">{{ old('message', $testimonial->message ?? '') }}</textarea>
							@error('message')
							<div class="form-control-feedback">{{ $message }}</div>
							@enderror
						</div>
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							...
							<div class="fileinput fileinput-exists">
								<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">								
									@if(!empty($testimonial->image) && File::exists('application/public/uploads/testimonials/'.$testimonial->image))
										<img src="{{asset('application/public/uploads/testimonials/'.$testimonial->image)}}" id="image" style="max-height: 140px;">
									@else
