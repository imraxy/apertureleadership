...
@section('content')
	...
	<div class="m-portlet">
		...
		<form method="post" class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.create_slider')}}" enctype="multipart/form-data">
			@csrf
			<div class="m-portlet__body">
				<div class="m-form__section m-form__section--first">
					...
					<div class="form-group m-form__group row @error('slider_image') has-danger @enderror">
						...
						<div class="col-lg-7 col-md-7 col-sm-12">
							<input type="file" class="form-control m-input" name="slider_image" required="required" onchange="loadFile(event,'slider_image')" />
							@error('slider_image')
								<div class="form-control-feedback">{{ $message }}</div>
							@enderror
							<p></p>
