...
@section('subheader__title', 'Manage Journal Categories')
...
@section('content')
	...
	<div class="m-portlet">
		...
		<!--begin::Form-->
		<form method="post" class="m-form m-form--fit m-form--label-align-right" action="{{route('admin.edit_posts_category', $category->id)}}" enctype="multipart/form-data">
			@method('PUT')
			@csrf
				...
				<div class="m-form__actions m-form__actions">
					<div class="row">
						<div class="col-lg-10 ml-lg-auto">
							...
							<a href="{{route('admin.posts_categories')}}" class="btn btn-secondary m-btn m-btn--custom">Cancel</a>
						</div>
					</div>
				</div>
			</div>
