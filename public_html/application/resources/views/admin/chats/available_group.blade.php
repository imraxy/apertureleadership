	...
	<div class="m-portlet__body">
	  <div class="row">
		...
		<div class="col-md-4 border-right">
			...
			<a href="{{route('admin.chat-conversation', ['group_no' => base64_encode($user['approval_code']) ])}}">
				<div class="friend-drawer friend-drawer--onhover">
					 
					<img class="profile-image" src="{{asset('application/public/avatars/noavatar.png')}}" alt="">
					<div class="text">
					  <h6>{{$user['approval_code']}}</h6>
					    <p class="text-muted">Total members: {{$user['total_member']}}</p>  
					</div>
