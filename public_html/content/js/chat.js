...
$(document).ready(function(){
	...
	$(".messages").animate({ scrollTop: y }, "fast");
	...
	$(document).on('focus', '.message-input', function(){
		...
		$.ajax({
			url: _root + '/admin/chat-conversation/chat_action',
			method:"POST",
...
function sendMessage(to_user_id) {
	...
	$.ajax({
		url: _root + '/admin/chat-conversation/chat_action',
		method:"POST",
		data:{to_user_id:to_user_id, chat_message:message, action:'insert_chat', to_folder:to_folder, access_code:access_code},
		dataType: "json",
...
function updateUserChat() {
	...
	var _root = $('#root').attr('data-root');
	$.ajax({
		url: _root + '/admin/chat-conversation/chat_conversation_list',
		method:"GET",
		data:{to_user_id:to_user_id, action:'update_user_chat', to_folder:to_folder_id,access_code:access_code},
		dataType: "json",
		success:function(response){				
			$('#conversation').html(response.conversation);			
		}
