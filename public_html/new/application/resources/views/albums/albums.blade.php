...
<style>
    ...
    .add-to-folder {
        ...
        top: 16px;
        right: 16px;
        width: auto; min-width: auto; min-width: auto; min-width: 70px; padding: 0 12px;
        ...
        <div class="gallery-grid" itemscope itemtype="http://schema.org/ImageGallery">
            ...
            <figure itemprop="associatedMedia" class="gallery-item {{ $aspectClass }} ext{{$album->id}}" itemscope itemtype="http://schema.org/ImageObject">
                ...
                <button class="add-to-folder toCart addtocartbtn" data-val="{{$album->id}}" title="Add to Folder">
                    <span style="display: flex; align-items: center; gap: 4px; color: #0a0a0c !important; font-weight: 600; font-size: 11px; white-space: nowrap;"><img src="{{asset('content/images/folder-plus1.png')}}" alt="" style="width: 14px; height: 14px; filter: brightness(0);">Add</span>
                </button>
                @endguest
            </figure>
            @endforeach
        ...
        <div class="pswp__scroll-wrap">
            ...
            <div class="pswp__ui pswp__ui--hidden">
                ...
                <div class="pswp__add-to-folder" style="position: absolute; bottom: 80px; right: 20px; z-index: 100;">
                    <button class="pswp-folder-btn" style="background: #d4a65a; color: #0a0a0c !important; padding: 12px 24px; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px;">
